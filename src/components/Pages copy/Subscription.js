...
const Subscription = ({ tier, name, email }) => {
  ...
  const showRazorPay = () => {
    ...
    form.setAttribute(
      ...
      `http://${BACKEND_URL}/api/payment/callback?tier=${t}&points=${points}&userId=${
        ...
        parseInt(checkerTier.cost) - coupon - points
      }&totalamount=${parseInt(checkerTier.cost)}`
    );
  ...
  useEffect(()=>{
    console.log("checker tier:", checkerTier)
  }, [])
        ...
        {checkerTier.tier === "1" && (
            ...
            >
              ...
              <div className="row">
                ...
                >
                  ₹ {checkerTier.cost - coupon - points}
                </div>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-8">
                ...
                <button
                  ...
                  onClick={() =>
                    createOrder(checkerTier.cost - coupon - points)
                  }
                >
                  Pay Now
                </button>
