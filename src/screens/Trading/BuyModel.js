                ...
                <div className="container">
                    ...
                    <div className="row mt-2">
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="number" class="form-control" value={triggeredPrice} disabled={market == 'market' || market == 'limit'} id="triggerPrice" onChange={(e) => setTriggeredPrice(e.target.value)} step={0.05} />
                        </div>
                    </div>
                    <div className="row mt-2">
                        <div className="col-md-12">
